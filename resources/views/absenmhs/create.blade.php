                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide"  action="{{ route('absenmhs.store')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        {{-- <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control" id="tanggal" name="tanggal" rows="5" placeholder=""></textarea>
                                            </div>
                                        </div> --}}
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="tanggal">Tanggal <span class="text-danger"></span>
