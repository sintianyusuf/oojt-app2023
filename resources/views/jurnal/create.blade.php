                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="{{ route('jurnal.store')}}" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="hari_tanggal">Hari Tanggal <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="mdate" name="hari_tanggal" placeholder="" >
                                            </div>
                                        </div>
